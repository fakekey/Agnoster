...
#ifndef AGNOSTER_KILLER_H
#define AGNOSTER_KILLER_H
...
namespace Killer {
    ...
    void StartKiller(JNIEnv *env, jclass clazz, jobject context);
    jobject ProcInvoke(JNIEnv *env, jclass clazz, jobject method, jobjectArray args);
} // namespace Killer
